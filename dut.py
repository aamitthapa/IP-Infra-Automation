...
rtcapture duration "+seconds_str+" count 100000000 file-name "+"AMIT_"+timestr+"_SAEGW_"+slot_final+"_1_5"+"\n"+"network-context SAEGW ip-interface SAEGW_"+slot_final+"_2_5 "+"startcapture duration "+seconds_str+" count 1000
00000 file-name "+"AMIT_"+timestr+"_SAEGW_"+slot_final+"_2_5"+"\n")
		test_log.close()
